...
public class SignupLoginPageTest_Freq extends BaseTest {
    ...
    public void verifySignup(String name, String email) throws IOException {
        ...
        SignupLoginPage_Freq signupLogin = new SignupLoginPage_Freq(driver);
    ...
    public Object[][] signupData() throws IOException {
        return ExcelUtilities.getdata(projectpath + "\\src\\test\\resources\\E_Commerce_Web_App_Testdata\\datafile.xlsx","Signup");
    }

    @DataProvider
    public Object[][] loginData() throws IOException {
        return ExcelUtilities.getdata(projectpath + "\\src\\test\\resources\\E_Commerce_Web_App_Testdata\\datafile.xlsx","Login");
    }
}
