...
import com.E_Commerce_Web_App.pages.ContactUsPage_Freq;
...
public class ContactUsPageTest_Freq extends BaseTest {
    ...
    public void verifyContactUsForm(String name, String email, String subject, String message) throws IOException {
        ...
        ContactUsPage_Freq contactUs = new ContactUsPage_Freq(driver);
    ...
    public Object[][] contactData() throws IOException {
        return ExcelUtilities.getdata(projectPath + "\\src\\test\\resources\\E_Commerce_Web_App_Testdata\\datafile.xlsx","ContactUs");
    }
}
