...
public class Based_impact_TC13 {
    WebDriver driver;
    WebDriverWait wait;
    ...
    public void setup() {
        ...
        extent = ExtentManager.createInstance("ReviewSubmitforimpact_TC13_Report.html");
    }

    @Test
    public void verifyReviewSubmitButtonWorks() {
        test = extent.createTest("Verify Review Submit Button - TC13");
